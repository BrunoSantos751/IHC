...
import { styles } from '../../styles/tabs/register.styles';
...
export default function RegisterScreen() {
  ...
  const formContent = (
    <View style={isWebLarge ? styles.webFormWrapper : { flex: 1 }}>
      ...
      <View style={[styles.headerContainer, isWebLarge && styles.webHeaderContainer]}>
        ...
        <View style={styles.titleContainer}>
          <Text style={[styles.title, isWebLarge && styles.webTitle]}>
            {isWebLarge ? 'Criar sua conta' : 'São Longuinho'}
          </Text>
          <Text style={[styles.subtitle, isWebLarge && styles.webSubtitle]}>
            {isWebLarge ? 'Cadastre-se rapidamente para começar a buscar ou anunciar objetos.' : 'Reconectando você ao que importa'}
          </Text>
        </View>
      </View>
      ...
      {/* Action Section */}
      <View style={[styles.actionContainer, isWebLarge && styles.webActionContainer]}>
        <Button 
          title="Criar conta" 
